...
const SERVICES: ServiceItem[] = [
  ...
  },
  {
    ...
    features: {
      fr: ['Architecture de conversion (AIDA)', 'Animations interactives fluides', 'Formulaires & intégration CRM', 'A/B testing & analytics'],
      en: ['Conversion-optimized flow', 'Fluid interactive micro-animations', 'Lead forms & CRM integration', 'Analytics & conversion tracking'],
    },
    icon: '🚀',
  },
  {
    ...
    tag: {
      fr: 'BOUTIQUE EN LIGNE & PAIEMENT',
      en: 'ONLINE SHOP & PAYMENTS',
    },
    description: {
      fr: 'Boutiques en ligne élégantes, performantes et sécurisées. Expérience d’achat sans friction, paiement Stripe simplifié et catalogue produit valorisé pour booster vos ventes.',
      en: 'Elegant, high-performance, and secure online shops. Frictionless checkout experience, seamless Stripe payments, and captivating product displays.',
    },
    features: {
      fr: ['Catalogue produits interactif', 'Tunnel d’achat Stripe / Shopify', 'Gestion des stocks & commandes', 'Optimisé pour le commerce mobile'],
